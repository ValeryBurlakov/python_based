...
def sort_files(path: Path, groups: dict[Path, list[str]] = None) -> None:
    chdir(path)
    if groups is None:
        groups = {Path('video'): ['mp4', 'wav', 'avi', 'mkv'],
                  Path('image'): ['png', 'jpeg', 'jpg', 'gif'],
                  Path('text'): ['docx', 'txt', 'doc', 'pdf']}
...
if __name__ == '__main__':
    sort_files(Path('/home/valery/PycharmProjects/basic-python/seminars/seminar_6'))
